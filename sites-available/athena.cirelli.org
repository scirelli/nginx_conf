...
server {
	...
	server_name athena.cirelli.org;

	return 301 https://$host$request_uri;

	root /var/www/html/athena.cirelli.org/html;
	index index.html index.htm;

    access_log /var/log/nginx/athena.cirelli.org/access.log;
    error_log /var/log/nginx/athena.cirelli.org/error.log;
    ...
    location /cgi-bin/ {
        gzip off;
        root /var/www/html/athena.cirelli.org;
...
server {
	...
	access_log /var/log/nginx/athena.cirelli.org/ssl_athena.cirelli.org_access.log;
	error_log /var/log/nginx/athena.cirelli.org/ssl_athena.cirelli.org_error.log;
