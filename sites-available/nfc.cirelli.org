...
server {
	...
	server_name nfc.cirelli.org;

	return 301 https://$host$request_uri;

	root /var/www/html/nfc.cirelli.org/html;
	index index.html index.htm;

    access_log /var/log/nginx/nfc.cirelli.org/access.log;
    error_log /var/log/nginx/nfc.cirelli.org/error.log;
    ...
    location /cgi-bin/ {
        gzip off;
        root /var/www/html/nfc.cirelli.org;
...
server {
    ...
    access_log /var/log/nginx/nfc.cirelli.org/ssl_nfc.cirelli.org_access.log;
    error_log /var/log/nginx/nfc.cirelli.org/ssl_nfc.cirelli.org_error.log;
