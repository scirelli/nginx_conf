...
server {
	...
	server_name amiibo.nfc.cirelli.org;
	
	add_header Strict-Transport-Security "max-age=31536000; includeSubDomains";
	return 301 https://$host$request_uri;

	root /var/www/html/amiibo.nfc.cirelli.org/html;
	index index.html index.htm;

    access_log /var/log/nginx/amiibo.nfc.cirelli.org/access.log;
    error_log /var/log/nginx/amiibo.nfc.cirelli.org/error.log;
    ...
    location /cgi-bin/ {
        gzip off;
        root /var/www/html/amiibo.nfc.cirelli.org;
...
server {
    ...
    access_log /var/log/nginx/amiibo.nfc.cirelli.org/ssl_amiibo.nfc.cirelli.org_access.log;
    error_log /var/log/nginx/amiibo.nfc.cirelli.org/ssl_amiibo.nfc.cirelli.org_error.log;
