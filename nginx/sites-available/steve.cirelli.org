...
server {
	...
	root /var/www/steve.cirelli.org/html;
...
server {
	...
	ssl on;
	#ssl_certificate /etc/nginx/ssl/steve.cirelli.org/self-ssl.crt; #cert.pem;
	#ssl_certificate_key /etc/nginx/ssl/steve.cirelli.org/self-ssl.key; #cert.key;
	...
	access_log /var/log/nginx/steve.cirelli.org/ssl_steve.cirelli.org_access.log;
	error_log /var/log/nginx/steve.cirelli.org/ssl_steve.cirelli.org_error.log;
	...
	location /cgi-bin/ {
		gzip off;
		root /var/www/steve.cirelli.org/cgi-bin;
