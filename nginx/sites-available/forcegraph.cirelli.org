...
server {
	...
	server_name forcegraph.cirelli.org;
	add_header Strict-Transport-Security "max-age=31536000; includeSubDomains";

	return 302 https://$host$request_uri;

	#root /var/www/cirelli.org/html;
	#index index.html index.htm;

	access_log /var/log/nginx/forcegraph.cirelli.org/access.log;
	error_log /var/log/nginx/forcegraph.cirelli.org/error.log;
...
server {
	...
	root /var/www/forcegraph.cirelli.org/html;
	index index.html index.htm;
	...
	access_log /var/log/nginx/forcegraph.cirelli.org/ssl_access.log;
	error_log /var/log/nginx/forcegraph.cirelli.org/ssl_error.log;
	...
	location /forcegraph {
		...
		proxy_pass http://forcegraph_websocket/forcegraph;
	}
