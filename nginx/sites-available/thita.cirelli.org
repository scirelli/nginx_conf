...
server {
	...
	server_name jen.cirelli.org jenly.cirelli.org thita.cirelli.org 192.168.1.235;
    ...
    access_log /var/log/nginx/jen.cirelli.org/access.log;
    error_log /var/log/nginx/jen.cirelli.org/error.log;
    ...
    location /cgi-bin/ {
        gzip off;
        root /var/www/html/jen.cirelli.org;
	...
	location = /50x.html {
		root /var/www/html/jen.cirelli.org/html;
	}
}
...
server {
    ...
    access_log /var/log/nginx/jen.cirelli.org/ssl_jen.cirelli.org_access.log;
    error_log /var/log/nginx/jen.cirelli.org/ssl_jen.cirelli.org_error.log;
